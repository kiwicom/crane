...
@click.option('--datadog-api-key', envvar='CRANE_DATADOG_API_KEY', default=None, help='')
@click.option('--datadog-app-key', envvar='CRANE_DATADOG_APP_KEY', default=None, help='')
