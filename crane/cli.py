...
@click.option('--new-image', envvar=['CRANE_NEW_IMAGE', 'RANCHER_SERVICE_IMAGE'], required=True, help='Docker image URL to upgrade to Example: --new-image $CI_REGISTRY_IMAGE:$CI_BUILD_REF')
