...
func TestNewNotification(t *testing.T) {
	...
	var tests = []struct {
		...
		{"WithCommits", []NotificationOption{WithCommits(commit.Commit{"sha1", "summary1", "author1"},
			commit.Commit{"sha2", "summary2", "author2"},
			commit.Commit{"sha3", "summary3", "author3"})},
			&Notification{
				Channels: []string{},
				Message:  "",
				Commits: []commit.Commit{commit.Commit{"sha1", "summary1", "author1"},
					commit.Commit{"sha2", "summary2", "author2"},
					commit.Commit{"sha3", "summary3", "author3"}},
				Timestamp: "",
			},
